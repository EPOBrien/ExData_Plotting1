...
#The following code creates and customizes the four graph sheet 

par(mfrow = c(2, 2), mar = c(4,4,1,0), oma = c(0,0,0,0))


  plot(datetime, datasubset$Global_active_power, type = "l",  #Creates a base line graph of global_active_power by datetime
    xlab = "Date & Time", ylab = "Global Active Power (Kilowatts)") #Labels the x and y axes
    #title("Global Active Power by Day") #Puts a title on the graph    


  plot(datetime, datasubset$Voltage, type = "l", col = "black",  #Creates a base line graph of Voltage by datetime
    xlab = "Date & Time", ylab = "Voltage") #Labels the x and y axes
    #title("Voltage by Day") #Puts a title on the graph
  ...
  plot(datetime, datasubset$Global_reactive_power, type = "l", col = "black")  #Creates a base line graph of Voltage by datetime
    #xlab = "Date & Time", ylab = "Global Reactive Power") #Labels the x and y axes
    #title("Global Reactive Power by Day") #Puts a title on the graph 


#The following code copies the graph to the .png device

png("plot4.png",  width = 480, height = 480, units = "px") #Sets .png pixel parameters
